...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default='ModelOutput/output_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default='ModelOutput/intermediate_graph/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='ModelOutput/output_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='ModelOutput/retrain_logs',
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default= 'ModelOutput/bottleneck',
  ...
  parser.add_argument(
      '--checkpoint_path',
      type=str,
      default='ModelOutput/_retrain_checkpoint',
